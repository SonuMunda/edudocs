...
const ShareMenu = ({ shareLink, shareTitle, menuOpen, setMenuOpen }) => {
  ...
  return (
    <div className="share-menu fixed bg-gray-200 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 backdrop-blur-3xl p-6 ring ring-gray-200 bg-white rounded-3xl max-w-sm w-full">
